def add_time(start, duration, starting_day=''):
    ...
    cur_min += int(duration.split(':')[0]) * 60 + int(duration.split(':')[1])
    ...
    new_week_day_msg = ', ' + week_days[(new_day + week_days.index(starting_day.lower())) % 7].title() if starting_day.lower() in week_days else ''

    # new_time = '{}:{:02d} {}{}{}'.format(new_h, new_min, new_am_pm, new_week_day_msg, new_day_msg)

    return '{}:{:02d} {}{}{}'.format(new_h, new_min, new_am_pm, new_week_day_msg, new_day_msg)